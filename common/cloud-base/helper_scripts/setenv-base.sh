...
export TF_VAR_base_name_prefix_unique_short="${name_prefix_unique_short}"
export TF_VAR_base_name_prefix_short="${name_prefix_short}"
export TF_VAR_base_name_prefix_long="${name_prefix_long}"
...
export TF_VAR_base_resources_internal_dns_apex="${resources_internal_dns_apex}"
export TF_VAR_base_resources_external_dns_zoneid="${resources_external_dns_zoneid}"
export TF_VAR_base_resources_external_dns_apex="${resources_external_dns_apex}"
export TF_VAR_base_main_public_alb_dns_name="${main_public_alb_dns_name}"
